...
export const metadata = { title: "The Bottleneck Audit — Jothi Swaroop", description: "Seven questions, an instant diagnosis of where your marketing is leaking, and a recorded teardown of your setup within 48 hours. Free.", alternates: { canonical: "/audit/" }, openGraph: { title: "The Bottleneck Audit — Jothi Swaroop", url: "/audit/", images: ["/og.png"] } };
