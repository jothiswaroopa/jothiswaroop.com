       ...
       <MotionProvider>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            performerIn: { "@type": "EducationEvent", name: "The Importance of Digital Marketing & AI Automation", description: "Seminar for 50+ entrepreneurs at a business networking meeting", location: { "@type": "Place", name: "Salem, Tamil Nadu, India" }, startDate: "2025-07" },
            areaServed: ["IN", "GB", "US"],
